export const experienceDirectory = [
  {
    company: "Finleap Connect, Berlin",
  ...
  {
    company: "Linux Foundation, Remote",
    timeLine: "June 2019 - February 2020",
    role: "Frontend Engineer",
    url: "https://optimistic-engelbart-1d97fa.netlify.app/",
    description: `Designed and delivered a user-facing application to help and support
      contributors sign CLAs for open source projects. I worked mostly with
      AngularJs, Ionic, SCSS.
      `,
  },

  {
    company: "Dirty Lemon, Remote",
    role: "Frontend Engineer",
    timeLine: "July 2018 - June 2018",
    description: `Applied my knowledge of usability principles, cross-browser
      compatibility, and HTML document architecture to help redesign
      the platform.`,
